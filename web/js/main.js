...
document.addEventListener('DOMContentLoaded', function () {
      ...
      wrap.addEventListener('click', function (e) {
        ...
        if (e.target.classList.contains('less')) {
          elems.forEach(function (el, i) {
            ...
            // 	if (e.target.getAttribute('data-less') == fullValue[i].getAttribute('data-full-price')) {
            // 		console.log(+fullValue[i].innerHTML)
            // 		console.log(+rez)
            // 		fullValue[i].innerHTML = +fullValue[i].innerHTML - +rez;
            // 	}
            // }
        ...
        if (e.target.classList.contains('more')) {
          elems.forEach(function (el, i) {
            ...
            // 	if (e.target.getAttribute('data-more') == fullValue[i].getAttribute('data-full-price')) {
            // 		fullValue[i].innerHTML = +fullValue[i].innerHTML + +rez;
            // 	}
            // }
  ...
  productRampUp2('.basketPay__right1', '.cards__int2', '.cards__item-priceJS', '.cards__item-price-FULL'); // конец
  ...
  changePositionElements4(); // let basketPayRight1Sm = document.querySelector('.basketPay__right1-sm');
  // let basketPayBottom = document.querySelector('.basketPay__bottom');
  // let basketPayRight1 = document.querySelector('.basketPay__right1');
  // const changePositionElements5 = () => {
  ...
  }); // let japaneseCuisine = document.querySelector('.japaneseCuisine');
  ...
  // function out() {
  // 	if (japaneseCuisine) {
  // 		japaneseCuisine.classList.add('active');
  // 	}
  // }
  // function out2() {
  // 	if (delivery) {
  ...
  mySearch('.header__bottom-filter', '.header__bottom-filter-cont', '.header__bottom-filter-wrap'); // mySearch('.header__top-addr-el > a', '.header__top-addr-cont');
  // mySearch('.footer__addr-modal', '.header__top-addr-cont2');
  // const outmapBlock = (myTarget, myWrap) => {
  ...
  // 	})
  // }
  // outmapBlock('.footer__addr-modal', '.header__top-addr-cont2');
  // outmapBlock('.header__addr-modal', '.header__top-addr-cont');
  // outmapBlock('.header__bottom-inp > .svg-sprite-icon', '.header__bottom-outInp');
  // outmapBlock('.t', '.header__bottom-filter-cont');
  // var footerMap = document.querySelector('.footer__addr-modal');
  // let t = document.querySelector('.header__top-addr-cont2');
  // footerMap.addEventListener('click', function (e) {
  // 	e.preventDefault();
  // 	t.classList.add('active');
  // 	return footerMap.classList.add('active');
  // });
  // document.addEventListener('click', function (e) {
  // 	if (!e.target.closest('.footer__addr-modal')) {
  // 		footerMap.classList.remove('active');
  ...
  customCheckboxBigBgRad.forEach(function (el, i) {
    el.addEventListener('change', function (e) {
      ...
      } else {// if (el.getAttribute('data-ch') == spBg[i].getAttribute('data-sp')) {
  ...
  if (delivery) {
    window.addEventListener('scroll', function (e) {
      ...
      if (scroll > offset) {
        delivery.classList.add('active');
      } else {// delivery.classList.remove('active');
      }
    });
  }
...
$(document).ready(function () {
  ...
  // 	}
  // });
  // $('.header__top-products-comparison').mouseover(function () {
  // 	$(".tkk").animate({
  // 	}, 1500, "linear", function () {
  // 		console.log(this)
  // 		$(this).text("Корзина - 450");	// изменяем текстовое содержимое нашему блоку и указываем цвет текста
  // 	}, 2000);
  // })
  // $('.header__top-products-comparison').mouseleave(function () {
  // 	$(".tkk").animate({
  // 	}, 1500, "linear", function () {
  // 		$(this).text("450");	// изменяем текстовое содержимое нашему блоку и указываем цвет текста
  // 	}, 2000);
  // })
